...
## Prerequisites
- Python 3.10+
- An OpenRouter API key stored in `OPENROUTER_API_KEY` (recommended) or provided at runtime
...
Features:
- Sidebar fields for OpenRouter API key (persisted for the session) and model name.
